...
const TermOfUser = () => {
  return (
    <Layout>
      <Box color="#d3d3d3" margin="60px 0" className={styles.container}>
        <p>
          This website is operated by ChapterWing. Throughout the site, the terms “we”, “us”,
          “Chapter Wing”, “ChapterWing”, “ChapterWing.com”and “our” refer to ChapterWing.
          ChapterWing offers this website, including all information, tools and services available
        ...
        <p>
          ...
          agree to be bound by the following terms and conditions (“Terms of Service”, “Terms of
          Use”, “Terms”), including those additional terms and conditions and policies referenced
          herein and/or available by hyperlink. These Terms of Service apply to all users of the
        ...
        <Heading>SECTION 1 – ONLINE STORE TERMS</Heading>
        <p>
        ...
        <Heading>SECTION 2 – GENERAL CONDITIONS</Heading>
        ...
        <Heading>SECTION 3 – ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</Heading>
        <p>
        ...
        <p>
          ...
          obligation to update any information on our site. You agree that it is your responsibility
          to monitor changes to our site.
        </p>
        <Heading>SECTION 4 – MODIFICATIONS TO THE SERVICE AND PRICES</Heading>
        <p>Prices for the products are subject to change without notice.</p>
        <p>
        ...
        <Heading>SECTION 5 – PRODUCTS OR SERVICES (if applicable)</Heading>
        <p>
        ...
        <p>
          The publishers (“Site users/viewers”, “artist”, “authors” etc.) display their product as
          they deem appropriate. We cannot guarantee that what you get is what you expected.
        </p>
        <p>
          We reserve the right, but are not obligated, to limit the sales of the products or
        ...
        <Heading>SECTION 7 – THIRD-PARTY LINKS</Heading>
        <p>
        ...
        <Heading>SECTION 8 – USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</Heading>
        <p>
        ...
        <Heading>SECTION 9 – ERRORS, INACCURACIES AND OMISSIONS</Heading>
        <p>
        ...
        <Heading>SECTION 10 – PROHIBITED USES</Heading>
        <p>
        ...
        <Heading>SECTION 11 – DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</Heading>
        <p>
        ...
        <p>
          In no case shall ChapterWing, our directors, officers, employees, affiliates, agents,
        ...
        <Heading>SECTION 12 – INDEMNIFICATION</Heading>
        <p>
          You agree to indemnify, defend and hold harmless ChapterWing and our parent, subsidiaries,
        ...
        <Heading>SECTION 13 – SEVERABILITY</Heading>
        <p>
        ...
        <Heading>SECTION 14 – TERMINATION</Heading>
        <p>
        ...
        <Heading>SECTION 15 – ENTIRE AGREEMENT</Heading>
        ...
        <Heading>SECTION 16 – GOVERNING LAW</Heading>
        <p>
          <strong>
            <strong> </strong>
          </strong>
        ...
        <Heading>SECTION 17 – CHANGES TO TERMS OF SERVICE</Heading>
        <p>
        ...
        <Heading>SECTION 18 – Copyright policy</Heading>
        <p>
          <strong>
            <strong> </strong>
          </strong>
        ...
        <p>
          As part of our policy, user access to the website might be terminated, if the user was
          found to be an infringer. In order to notify us of a copyright infringement, you will need
          to contact us, providing which novel you believe to be an infringer of a copyright,
          explaining which way it is an infringer of copyright (Plagiarism, part of the text is
          copied, etc. ) and from whom/what (a published story, something available on the internet
          etc.)
        </p>
        <p>
          Provide a contact information for the publisher of the reported content to be able to
          contact you and to resolve the complaint directly (if they were to disagree, have
          permission etc.”)
        </p>
        <p>
          When you contact us to report that, you confirm your belief that the content you are
          reporting is a copyright infringement and is not approved the copyright owner.
        </p>
        <p>
          <strong>
            <strong> </strong>
        ...
        <Heading>SECTION 19 – COPYRIGHT PROTECTION</Heading>
        <p>
          <strong>
            <strong> </strong>
          </strong>
        ...
        <p>
          Anything you write is automatically copyrighted by you, but that does not mean it would be
          registered in your country copyright office.
        </p>
        <p>
          You may use <a href="http://www.copyrighted.com/">http://www.copyrighted.com/</a> or other
          avilable resources for such.
        </p>
        <p>
          Note that once posted at ChapterWing, your content would be marked as your own, with a
          date on the post that verifies when the content was published, we would also save your
          content in our database with any edit you make, to back any third party investigation with
          accurate information and avoid erroneous copyright claims.
        </p>
        <p>
          <strong>
            <strong> </strong>
        ...
        <Heading>SECTION 20 – ADVERTISING</Heading>
        <p>
          <strong>
            <strong> </strong>
          </strong>
        ...
        <p>
          ChapterWing may, at its full discretion, provide users additional marketing and
          advertising exposure including but not limited to marketing and promotion via social
          media, newsletters and marketing emails.
        </p>
        <p>
          <strong>
            <strong> </strong>
        ...
        <p>
          User grants to ChapterWing the right to publish, use, reference, and display User’s name
          and other information, including but not limited to quotes, names, or pictures of, related
          to, and about the content.
        </p>
        <p>
          <strong>
            <strong> </strong>
        ...
        <p>
          Users will obtain sufficient permissions from their content-supporters(“Co-publisher”,
          “proofreaders”, “artists”, “sidekick” etc.) whose quotes, names, pictures, and/or other
          materials ChapterWing may use. Users grant to us any and all rights necessary for us to
          perform the actions described in the preceding sentence.
        </p>
        <p>
          <strong>
            <strong> </strong>
        ...
        <Heading>SECTION 21 – CONTACT INFORMATION</Heading>
        <p>
          <strong>
            <strong> </strong>
          </strong>
        ...
        <p>
          Questions about the Terms of Service should be sent to us via the{' '}
          <a href="/contact">Contact us page</a>
        </p>
        <Heading>SECTION 22 – PUBLISHER CONDUCT</Heading>
        <p>As a publisher you may publish anything you want, excluding mature(“Sexual”) images</p>
        <p>User submitted content are collectively referred to as “Content.”</p>
        <p>
          You shall be solely responsible for your own Content and the consequences of posting or
          publishing them. In connection with the content, you affirm, represent, and/or warrant
          that: you own or have the necessary licenses, rights, consents, and permissions to use and
          authorize ChapterWing to use all patent, trademark, trade secret, copyright or other
          proprietary rights in and to any and all the Contents and have all necessary consents to
          collect, use and disclose any personally identifiable information contained or displayed
          in any and all the Contents to enable inclusion and use of the the Contents in the manner
          contemplated by the Website and these Terms of Service.
        </p>
        <p>
          You agree that you will not submit material that is copyrighted, protected by trade secret
          or otherwise subject to third party proprietary rights, including privacy and publicity
          rights, unless you are the owner of such rights or have permission from their rightful
          owner and the necessary consents from any individuals whose personally identifiable
          information is contained in such material to post the material and to grant us all of the
          license rights granted herein.
        </p>
        <p>
          We will remove all Content and User Submissions if properly notified that such Content or
          User Submission infringes on another’s intellectual property rights or contravenes any
          applicable privacy legislation. We reserves the right to remove Content and User
